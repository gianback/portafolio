...
export const ProjectCard = ({ description, image, name, technologies, url, code }: ProjectCardProps) => {
   return (
      <article className="flex flex-col laptop:grid grid-cols-2 gap-4 laptop:gap-14">
         <picture className="flex items-start justify-center">
         ...
         <div>
            ...
            <div className="flex gap-4">
               ...
               <div className="flex gap-4 mt-4 ">
                  {technologies.map((tech) => (
                     <picture key={tech} className="flex items-center justify-center w-7" title={tech.toUpperCase()}>
            ...
            <div className="flex gap-4 laptop:gap-6 mt-4 laptop:mt-6">
               <a
                  href={url}
                  target="_blank"
                  className="flex gap-3 items-center bg-primary text-black font-medium py-2  px-4  desktop:text-lg rounded-lg hover:bg-white transition-all duration-75 ease-linear"
               >
                  Ver sitio
