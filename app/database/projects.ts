export const projects = [
  ...
  },
  {
    ...
    name: "Chat Group",
    description:
      "Chat Group fue un proyecto elaborado en equipo, el cual es un aplicativo divertido y entretenido que te permite conectarte con personas alrededor del mundo en un ambiente social y amistoso. Ya sea que te guste hablar sobre tus intereses, hacer nuevas amistades o simplemente divertirte con personas que compartan tus mismas ideas, Chat Group es el lugar ideal para ti.",
    image: "/chat-group.webp",
    url: "https://chat-group-beta.vercel.app/",
    code: "https://github.com/gianback/chat-group",
    technologies: ["nextjs", "supabase", "typescript", "tailwindcss", "git"],
  },
  {
    id: 3,
    name: "Chile Tacos",
  ...
  },
  {
    ...
    description:
      "Jimenez Painting cuenta con más de 5 años de experiencia proporcionando soluciones de pintura y sirviendo con orgullo un radio de 35 millas alrededor de Modesto, California.",
    image: "/jimenez.webp",
    url: "https://jimenezpainting209.com/",
    technologies: ["typescript", "nextjs", "strapi", "tailwindcss"],
  },
  {
    id: 1,
